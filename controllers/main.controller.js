...
module.exports.login = async (req, res)=>{
    ...
    if(x)
    {
        ...
        {
            jwt.sign({_id: z._id, email: z.email, name: z.name, role: "admin", age: z.age, address: z.address, phoneNumber: z.phoneNumber},'yasmine',(err,token)=>{
                res.json({token: token, _id: z._id, email: z.email, name: z.name, role: "admin", age: z.age, address: z.address, phoneNumber: z.phoneNumber})
            })
        }
        else
        {
